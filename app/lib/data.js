...
export const footerContent = [
  {
    left: [
      { label: "CYTSA" },
      { label: "Conexiones y Transformaciones Plásticas de Monterrey S.A de C.V" },
      { label: "2024" },
    ],
  },
  {
    right: [
      { label: "Tel: (81)80-32-77-00 /  Fax: (81) 80-32-77-01" },
      { label: "Del poniente #273, Col. Parque industrial Microempresarios del Pte." },
      { label: "66369" },
      { label: "Santa Catarina, Nuevo León, México" },
    ],
  }
]
