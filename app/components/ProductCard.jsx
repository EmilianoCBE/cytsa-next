...
export const ProductCard = ({ link, title, image }) => {
  return (
    <Link href={link} target='_blank' className='cursor-pointer w-[345px] md:w-[660px]'>
      <div className='w-full h-full relative overflow-hidden group'>
        ...
        <div className='absolute bottom-0 left-0 w-full px-8 py-20 bg-transparent overflow-hidden'>
          ...
          <div className="absolute inset-0 bg-orange-500 w-0 transition-all duration-500 group-hover:w-full z-0"></div>
        </div>
      </div>
    </Link>
  );
