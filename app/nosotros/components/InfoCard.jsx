...
export const InfoCard = ({title, description, iconImage}) => {
  return (
    <div className="text-black hover:text-slate-100 border-gray-500 border py-6 md:py-10 px-8 hover:border-orange-500 hover:bg-orange-500 transition-all ease-in-out flex flex-col-reverse h-full md:flex-row gap-2 md:gap-20">
